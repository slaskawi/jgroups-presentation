 ...
 * </ul>
 */
public class Demo3_SimpleChatClientWithRPC extends ReceiverAdapter {
    ...
    public static void main(String[] args) throws Exception {
        new Demo3_SimpleChatClientWithRPC().runClient();
    }
    ...
    private void runClient() throws Exception {
        ...
        while (true) {
            try {
                ...
                RspList<Void> rsps=dispatcher.callRemoteMethods(null, sendMessage, RequestOptions.ASYNC());
                logger.info("Responses :: {}", rsps);
